                ...
                InkWell(onTap: () {controller.loginWithPhoneNumber(emailCon.text);
                  ...
                  width: Dimensions.height50*5,
                    decoration: BoxDecoration(
                        borderRadius:
                            BorderRadius.circular(Dimensions.radius15),
                        color: Color.fromARGB(255, 235, 100, 120)),child: Center(child: BigText(text: "تسجيل دخول",size: 13,color: Colors.white,)),
                  ),
                ),SizedBox(height: Dimensions.height20,),Padding(padding: EdgeInsets.only(right: Dimensions.height45),
                  child: Row(crossAxisAlignment: CrossAxisAlignment.center,
                    children: [ Text(' تجربتك الاولى مع كوزمو؟',style: TextStyle(color: black,fontFamily: 'Cairo',fontSize: 13)),SizedBox(width: Dimensions.height10,),
                      InkWell(onTap: () {
                        
                      },child: Text('انشاء حساب',style: TextStyle(fontSize: 13,color: black,fontFamily: 'Cairo',decoration: TextDecoration.underline)),),
                    ],
                  ),
                )
              ],
