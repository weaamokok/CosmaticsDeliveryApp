  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: Colors.white,body: SingleChildScrollView(
      child: Column(children: [Align(
              ...
              child: Container(margin: EdgeInsets.only(top: Dimensions.height20),
                    ...
                    Expanded(flex: 5,
                      child: TextFormField(
                        ...
                        decoration:  InputDecoration(
                          hintText:'${listOfProducts.first.brand.toString()} ابحث في منتجات  ',
            ...
            ),Container(padding: EdgeInsets.symmetric(horizontal: Dimensions.width20),
