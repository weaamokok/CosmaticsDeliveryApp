...
class CatagorySection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<BrandsController>(builder: (controller) {
      ...
      child: SizedBox(height: Dimensions.height100,
        child: ListView(
          ...
          children: [
            CatagoryCard((){                        Get.to(() => BrandsPage(listOfProducts: controller.getBrandsList[1],));
},svgNormalSkin, 'عادية', Colors.white,),
...
class CatagoryCard extends StatelessWidget {
  const CatagoryCard(this.onTap,this.illustration, this.catagory, this.cardsColor, {super.key});
